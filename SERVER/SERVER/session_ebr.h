...
public:
    ...
    void push_ptr(ServerObject* ptr) {
    ...
    template <typename ObjectType, typename... Args> requires 
        std::derived_from<ObjectType, ServerObject> and std::is_constructible_v<ObjectType, Args...>
...
public:
    ...
    inline static thread_local std::array<std::queue<ServerObject*>, TAG_CNT> _free_queue{ };
